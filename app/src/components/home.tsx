...
const Home : FC = () => {
  ...
  return (
    <main>
    <section className="text-[#4b5563] body-font-roboto">
...
<section className="text-[#4b5563] body-font">
  <div className="container px-5 py-24 mx-auto">
    ...
    <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
      <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
        <div className="w-20 h-20 inline-flex items-center justify-center rounded-full bg-[#dbeafe] text-cex mb-5 flex-shrink-0">
